...
```mermaid
flowchart LR
    A[Product or experience] --> B[Meaningful promise]
    B --> C[Identity possibility]
    C --> D[Audience feels, imagines, or becomes]
    D --> E[Choice and continued use]
    F[Culture and context] --> B
    F --> C
    G[Evidence and experience] --> B
    G --> E
```
